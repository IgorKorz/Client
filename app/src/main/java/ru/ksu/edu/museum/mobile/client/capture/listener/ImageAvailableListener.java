...
//        receiveThread.start();
            ...
            byte[] data = new byte[0];//userClient.receive();

            if (data != null) {
                try {
                    String response = "{\"DetectedMarkersCount\":1,\"Corners\":[[{\"IsEmpty\":false,\"X\":100.0,\"Y\":100.0},{\"IsEmpty\":false,\"X\":200.0,\"Y\":100.0},{\"IsEmpty\":false,\"X\":200.0,\"Y\":200.0},{\"IsEmpty\":false,\"X\":100.0,\"Y\":200.0}]],\"Ids\":[42]}-";//new String(data);
    ...
    private Mat imageToMat(Image image) {
        ...
        buffer.get(bytes);
        Mat bufferMat = new Mat(image.getHeight(), image.getWidth(), CvType.CV_8U);
